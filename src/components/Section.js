...
const components = ['Counter', 'ThemeChanger', 'CustomRedux'];
const makeLazy = (component) => ({ [component]: lazy(() => import(`contents/${component}`) ) });
  ...
  return (
    <Provider store={store}>
      <Suspense fallback={<Loading />}>
        <Content title={content} content={<Component />}/>
      </Suspense>
      <div>
        <span>Examples:</span>
        {
